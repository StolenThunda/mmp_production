...
class Composer {
	...
	public static function compose(EmailCache $email = NULL)
	{
		...
		ee()->cp->add_to_foot('<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>');
		return array($vars);
	}
	...
	private function deliverEmail(EmailCache $email, $to, $cc = NULL, $bcc = NULL)
	{
		...
		ee()->email->message($tmp_message, $tmp_plaintext);
	...
	public static function sent()
	{
		...
		$table->setNoResultsText('no_cached_emails', 'compose_heading', ee('CP/URL',EXT_SETTINGS_PATH.'/email:compose'));
